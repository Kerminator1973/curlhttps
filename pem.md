...
С целью идентификации общей части кода проверки сертификата сервера (в том числе, самоподписанного), сравнил соответствующую реализацию в проложениях с использование curllib, Boost.Beast и Android.
...
4. **.PFX** — контейнер для хранения сертификата с открытым ключём и закрытого ключа. Используется в Microsoft IIS и на платформе .NET
