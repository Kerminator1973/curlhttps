...
1. Настройкой vcproj и sln. Можно попробовать заимствовать [решение kiyolee](https://github.com/kiyolee/zlib-win-build).
2. Применением CMake
...
4. Попробовать использовать [vcpkg](https://docs.microsoft.com/ru-ru/cpp/build/vcpkg?view=vs-2019)
