...
Решение рассматривается как альтернатива **Boost.Beast**. Приложение **curl** входит в состав операционной системы Microsoft Windows 10, что автоматически делает использование библиотеки curl более предпочтительным, чем Boost.Beast.
